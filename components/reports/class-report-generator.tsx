...
import { ClassReportView } from "@/components/reports/class-report-view"
...
export function ClassReportGenerator({ classes, terms, academicYears, exams }: ClassReportGeneratorProps) {
  ...
  const generateReport = async () => {
    ...
    setLoading(true)
    try {
      let url = `/api/reports/class/${selectedClassId}?`
        ...
        <div className="space-y-2">
          ...
          <Select value={selectedExamId} onValueChange={setSelectedExamId}>
            ...
            <SelectContent>
              ...
              {exams
                .filter((exam) => !selectedClassId || exam.classId === selectedClassId)
                .map((exam) => (
